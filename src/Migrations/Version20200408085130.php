 ...
 */
final class Version20200408085130 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE technology (id INT NOT NULL, PRIMARY KEY(id))');
    }
